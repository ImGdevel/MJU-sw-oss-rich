EMOJI = {
    ...
    "cheerup": "⎝̐̈⎛̐̈•̐̈‿̐̈•̐̈⎞̐̈⎠̐̈",
    "birthdayemotion": "( ◔⊰◔)-=🎂三三☲=💨",
    "gogo" : "█▬▬ ◟(`ﮧ´ ◟ )",
    "d?" : "ʕ •̀ o •́ ʔ",
    "wantgodie" : "(ʘ言ʘ╬)",
    "thebest" : "ദ്ദി ˉ͈̀꒳ˉ͈́ )✧",
    "worried" : "=͟͟͞͞(๑º ﾛ º๑)",
    "thinking" : "𖦹 ˍ 𖦹", 
    "exciting" : "٩༼๑･ิﻌ･ิ༽۶٩༼･ิﻌ･ิ๑༽۶",
    "ok" : "१✌˚◡˚✌५",
    "wink" : "(*⸰‿-) (☉_☉) (-‿◦☀)",
    "hi" : "(~˙∇˙)~📣",
    "left" : "(◞º❒º)◞₎₎(◟º❑º)◟⁾⁾➟➠➨",
    ...
    "sad" : "ミ꙳.ヾ🚰ㅅ🚰ﾉﾞ♡",
    "sosad" : ".·´¯`(>▂<)´¯`·.",
    "sososad" : "(´°̥̥̥̥̥̥̥̥ω°̥̥̥̥̥̥̥̥)",
    "hala" : "ヾ(´•👅•｀)ノ",
    "love" : "⎝⎛♥‿♥⎞⎠",
    "bear" : "( ິ◕ ˕ ◕ )ິ",
    "cat" : "( ͒ ˘̩̩̩̩̩̩ꇵ͒˘̩̩̩̩̩̩ ͒)",
    "dog" : "｡:˚ ૮ ˶ ˆ ᴥ ˆ ˶ ა ˚ :｡",
    "fish" : "ʚʘ͜͡)))))⫷",
    "listening" : "ᖰ₍ᐢ•ﻌ•ᐢ₎ᖳ",
    "Zzz" : "ᓬᗸᗳ[▓▓]ꍞ",
    "run" : "=͟͟͞͞ʕ•̫͡•ʔ =͟͟͞͞ʕ•̫͡•ʔ =͟͟͞͞ʕ•̫͡•ʔ =͟͟͞͞ʕ•̫͡•ʔ =͟͟͞͞ʕ•̫͡•ʔ",
    "magic" : "╰( ´・ω・)つ──☆✿✿✿✿✿✿",
    "fuck" : "( o˘◡˘o) ┌iii┐",
    "strong" : "ᕙ༼*◕_◕*༽ᕤ",
    "surprise" : "╰༼=ಠਊಠ=༽╯",
    "Ikilly" : "༼ง ͠ຈ ͟ل͜ ͠ຈ༽o:[]:::::::>",
    "haha" : "✺◟( ͡° ͜ʖ ͡°)◞✺",
    "4dollar" : "[̲̅4$̲̅(̲̅ ͡° ͜ʖ ͡°̲̅)̲̅4$̲̅]",
    "Letsparty" : "🍸🍸🍸🍸🍸🍸🍸🍸🍸🍸🍸🍸Let's P-A-R-T-Y!🍸🍸🍸🍸🍸🍸🍸🍸🍸🍸🍸🍸",
    "thief" : "🥷",
    "king" : "👷",
